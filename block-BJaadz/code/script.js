...
let setBorder = allHrs.forEach(ele => ele.style.border = "1px solid tomato" )

// Change the background of all the hr to "antiquewhite" using for of loop.
let background = allHrs.forEach(ele => ele.style.backgroundColor = "antiquewhite" )

// Change the 'border-radius' of all the hr to "5px" using array.
let borderRadius = allHrs.forEach(ele => ele.style.borderRadius = "5px" )
...
let borderChanged = allHrs.forEach(ele => ele.style.border = "dashed")
